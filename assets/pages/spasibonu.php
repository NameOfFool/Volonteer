...
<div class="intro">
    <div class="container">
        <div class="intro__inner">
            ...
            <p style="font-size: 25px; margin-top: 50px;">В ближайшее время с вами свяжутся волонтёры, находящиеся по близости, и обязательно помогут вам</p>
            <a class="but" href="index.php">На главную</a> 
        </div>
        </div>          
    </div>
</body>
